...
export function mountGraph(panel,{neighborhood,subject,lines,url,onDepth}){
  ...
  function draw(layout,edges){
    ...
    listen(body.querySelector('[data-original]'),'click',originalSize);
